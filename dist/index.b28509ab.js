...
})({"aK44q":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "1833f087b28509ab";
...
},{}],"aWcaz":[function(require,module,exports) {
(()=>{
    const refs = {
    ...
    for (let button of openModal)button.onclick = function(e) {
        e.preventDefault();
    ...
    refs.modal.onmousedown = function(e) {
        ...
        if (e.target.closest("." + content.className) === null) toggleModal();
    };
    refs.geo.onmousedown = function(e) {
        let target = e.target;
        let content = document.querySelector(".modal-geo");
        if (e.target.closest("." + content.className) === null) toggleGeo();
    };
    refs.franch.onmousedown = function(e) {
        let target = e.target;
        let franchContent = document.querySelector(".modal-franchise");
        if (e.target.closest("." + franchContent.className) === null) toggleFranch();
    };
    refs.about.onmousedown = function(e) {
        let target = e.target;
        let content = document.querySelector(".modal-about");
        if (e.target.closest("." + content.className) === null) toggleAbout();
    };
})();

},{}]},["aK44q","aWcaz"], "aWcaz", "parcelRequired7c6")

//# sourceMappingURL=index.b28509ab.js.map
